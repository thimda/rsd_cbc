...
<PageMeta caption="表单内容管理">
    ...
    <Listeners>
        <PageListener id="formcate_defaultListener" serverClazz="nc.uap.dbl.frmtmpmgr.FrmtmpmgrPageInitListener">
            <Events>
...
<Menus>
 <MenuBarComp id="tmenu">
            <MenuItem displayHotKey="CTRL+SHIFT+" id="add" modifiers="3" operatorStatusArray="0,1,2" text="新增">
                <Listeners>
                    <MouseListener id="addLis" serverClazz="nc.uap.dbl.frmtmpmgr.FrmTmpMgrListener">
                        <Events>
            ...
            <MenuItem displayHotKey="CTRL+SHIFT+" id="edit" modifiers="3" operatorStatusArray="1" text="编辑">
                <Listeners>
                    <MouseListener id="editLis" serverClazz="nc.uap.dbl.frmtmpmgr.FrmTmpMgrListener">
                        <Events>
                            <Event async="true" name="onclick" onserver="true">
                                <SubmitRule cardSubmit="false" panelSubmit="false" tabSubmit="false">
                                    <Widget cardSubmit="false" id="main" panelSubmit="false" tabSubmit="false">
            ...
            <MenuItem displayHotKey="CTRL+SHIFT+" id="del" modifiers="3" operatorStatusArray="1,2" text="删除">
                <Listeners>
                    <MouseListener id="delLis" serverClazz="nc.uap.dbl.frmtmpmgr.FrmTmpMgrListener">
                        <Events>
                            <Event async="true" name="onclick" onserver="true">
                                <SubmitRule cardSubmit="false" panelSubmit="false" tabSubmit="false">
                                    <Widget cardSubmit="false" id="main" panelSubmit="false" tabSubmit="false">
...
<MenuItem displayHotKey="CTRL+SHIFT+" id="cancel" modifiers="3" operatorStatusArray="3,4" text="取消">
            ...
            <MenuItem displayHotKey="CTRL+SHIFT+" id="enable" modifiers="3" operatorStatusArray="1,2" text="启用">
                <Listeners>
                    <MouseListener id="enableLis" serverClazz="nc.uap.dbl.frmtmpmgr.FrmTmpMgrListener">
                        <Events>
                            <Event async="true" name="onclick" onserver="true">
                                <SubmitRule cardSubmit="false" panelSubmit="false" tabSubmit="false">
                                    <Widget cardSubmit="false" id="main" panelSubmit="false" tabSubmit="false">
