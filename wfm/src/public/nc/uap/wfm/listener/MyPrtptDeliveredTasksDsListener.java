...
public class MyPrtptDeliveredTasksDsListener extends DefaultDatasetServerListener {
	public MyPrtptDeliveredTasksDsListener(LfwPageContext pagemeta, String widgetId) {
	...
	protected SuperVO[] queryVOs(PaginationInfo pinfo, SuperVO vo, String wherePart) throws LfwBusinessException {
		...
		SuperVO[] vos = null;
		try {
			vos = NCLocator.getInstance().lookup(IWfmTaskQry.class).getMyDeliveredTasks(userPk, proDefPk, pinfo);
