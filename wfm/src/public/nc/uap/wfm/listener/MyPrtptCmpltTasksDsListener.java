...
public class MyPrtptCmpltTasksDsListener extends DefaultDatasetServerListener {
	public MyPrtptCmpltTasksDsListener(LfwPageContext pagemeta, String widgetId) {
	...
	protected SuperVO[] queryVOs(PaginationInfo pinfo, SuperVO vo, String wherePart) throws LfwBusinessException {
		...
		SuperVO[] vos = null;
		try {
			vos = NCLocator.getInstance().lookup(IWfmTaskQry.class).getMyCmpltTasks(userPk, proDefPk, pinfo);
