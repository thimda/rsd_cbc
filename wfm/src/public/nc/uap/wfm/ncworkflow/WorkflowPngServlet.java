...
public class WorkflowPngServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		String billType = req.getParameter(WfmConstants.WfmUrlConst_FlowTypePk);
		...
		try {
			...
			// g.drawString(NCLangRes4VoTransl.getNCLangRes().getStrByID("yer",
			// "yer_pfmsg01")/*当前单据未设定流程!*/, 20, 40);
