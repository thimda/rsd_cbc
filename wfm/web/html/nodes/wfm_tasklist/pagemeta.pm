...
<PageMeta caption="我的工作">
    ...
    <Widgets>
        ...
        <Widget id="query" refId="query">
        </Widget>
        <Widget id="uerge" refId="uerge">
        </Widget>
    </Widgets>
    <Listeners>
        <PageListener id="myprtptprocess_defaultListener" serverClazz="nc.uap.lfw.core.event.deft.DefaultPageServerListener">
            <Events>
