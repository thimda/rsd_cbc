...
<PageMeta caption="按功能节点设置代理人">
    ...
    <Listeners>
        <PageListener id="myagentsetting_defaultListener" serverClazz="nc.uap.lfw.core.event.deft.DefaultPageServerListener">
            <Events>
                ...
                <Event async="true" name="afterPageInit" onserver="false">
                    ...
                    <Action>                        <![CDATA[pageUI.getWidget("main").getMenu("menu_agent").getMenu("save").setActive(false);
pageUI.getWidget("main").getMenu("menu_agent").getMenu("cancel").setActive(false);]]>
                    </Action>
                </Event>
