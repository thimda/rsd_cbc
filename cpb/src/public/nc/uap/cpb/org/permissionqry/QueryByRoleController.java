...
public class QueryByRoleController {
	...
	private void loadData() {
		...
		String pk_role = ref_text.getValue();
//pk_role = "0000Z010000000001BUD";
		...
		try {
			list = CpbServiceFacility.getCpPermissionQryService().getPermissionsByRole(new String[] { pk_role }, pinfo);
