...
public class QueryByUserController { 
	...
	private void loadData() {
		LfwWidget main = AppLifeCycleContext.current().getWindowContext().getViewContext(VIEW).getView();	
		  ReferenceComp ref_text = (ReferenceComp) main.getViewComponents().getComponent(REF_TEXT);
		  String pk_user = ref_text.getValue();
		  ...
		  try {
			list = CpbServiceFacility.getCpPermissionQryService().getPermissionsByUser(new String[]{pk_user},pinfo);
