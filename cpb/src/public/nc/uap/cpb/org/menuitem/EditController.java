...
public class EditController implements IController {
  ...
  public void onBeforeShow(  DialogEvent dialogEvent){
    String opeStatus = (String) getCurrentWinCtx().getAppAttribute(MenuitemConstants.OPERATE_STATUS);
	  ...
	  if(MenuitemConstants.ADD_OPERATE.equals(opeStatus)){		  	
		    ...
		    Row oldrow = (Row)getCurrentWinCtx().getAppAttribute(MenuitemConstants.DATA);
		  	// 新增行并选中
			Row row = ds.getEmptyRow();
