...
public class CpDeviceQry implements ICpDeviceQry {
	@Override
	public CpDeviceVO[] getAllDevice() throws CpbBusinessException {
	...
	@Override
	public CpDeviceVO getDeviceVoByPk(String devicePk) throws CpbBusinessException {
		PtBaseDAO dao = new PtBaseDAO();
		CpDeviceVO[] vos = null;
		try {
