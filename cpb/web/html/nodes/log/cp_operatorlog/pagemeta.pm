...
<PageMeta caption="操作日志" controllerClazz="nc.uap.cpb.log.operatorlog.OperatorLogCtrl" id="cp_operatorlog" sourcePackage="cpb/src/public/" windowType="win">
