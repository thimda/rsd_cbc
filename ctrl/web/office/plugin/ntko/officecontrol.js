...
OfficeControl.prototype.initOfficeControl = function (userSettings) {
	try {
		...
		//加盖服务器印章前事件
		this.OnBeforeDoSecSign = function(UserName,SignName,SignUser,SignSN, IsCancel){};
		if(userSettings.OnBeforeDoSecSign)
			this.OnBeforeDoSecSign = userSettings.OnBeforeDoSecSign;
		//加盖EKEY印章后事件
		this.OnBeforeDoSecSignFromEkey = function(UserName,SignName,SignUser, SignSN, EkeySN, IsCancel){};
		if(userSettings.OnBeforeDoSecSignFromEkey)
			this.OnBeforeDoSecSignFromEkey = userSettings.OnBeforeDoSecSignFromEkey;
		//加盖印章中事件
		this.OnSecSignSetInfo = function(Username, SignType,SecSignObject){};
		if(userSettings.OnSecSignSetInfo)
			this.OnSecSignSetInfo = userSettings.OnSecSignSetInfo;
		//印章删除事件
...
OfficeControl.prototype.AfterLoad= function (pk){
	...
	{
		if(pk)
			this.curobj.OpenFromURL(loadurl, false);
		else
			this.curobj.BeginOpenFromURL(loadurl, false, false);
...
OfficeControl.prototype.addEvent= function (){
	...
	this.curobj.attachEvent("OnBeforeDoSecSign", 
		(function(obj){return function(UserName,SignName,SignUser,SignSN, IsCancel){return  BeforeDoSecSign(obj,UserName,SignName,SignUser,SignSN, IsCancel);}})(this));
	
	this.curobj.attachEvent("OnBeforeDoSecSignFromEkey",
			(function(obj){return function(UserName,SignName,SignUser, SignSN, EkeySN, IsCancel){return  BeforeDoSecSignFromEkey(obj,UserName,SignName,SignUser, SignSN, EkeySN, IsCancel);}})(this));
			
	this.curobj.attachEvent("OnSecSignSetInfo", 
...
function BeforeDoSecSign(ofctl,UserName,SignName,SignUser,SignSN, IsCancel){
	ofctl.OnBeforeDoSecSign(UserName,SignName,SignUser,SignSN, IsCancel);
}
...
OfficeControl.prototype.saveFileToURL = function (pk){
	...
	var msg = "";
	try{
		msg = this.curobj.SaveToURL(saveURL, savepk,"",savepk,false);
