...
<PageMeta caption="office 文档管理" id="office\officeFileManager">
    ...
    <Listeners>
        <PageListener id="officeFileManager_defaultListener" serverClazz="nc.uap.lfw.ncadapter.deft.NCDefaultPageServerListener">
            <Events>
