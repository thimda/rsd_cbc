...
public class CpGzInitTool {
	...
	private void addOneLine(Dataset ds, Row row, IAttribute attribute, Dataset targetDs, String pk_template) {
		...
		//得到存有默认数据的vo
		CpGzConditionVO cvo = getDefaultItemVO(index);
		cvo.setPk_gz_template(pk_template);
...
//	}
	 ...
	 */
	public CpGzConditionVO getDefaultItemVO(int row) {
		CpGzConditionVO item = new CpGzConditionVO();
